...
public class AuthorController {
    ...
    @PostMapping
    public ResponseEntity<AuthorDTO> createAuthor(@RequestBody AuthorRequestDto authorRequestDto) {
        log.info("Start Resource create a new author with name {}", authorRequestDto.getName());
        AuthorDTO createdAuthor = authorService.createAuthor(authorRequestDto);
